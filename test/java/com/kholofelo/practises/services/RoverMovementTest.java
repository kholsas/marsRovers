...
public class RoverMovementTest {
	...
	@Test
	public void testMMRMMRMRRM() {
		movement.setPlateuCoordinates(5, 5);
		movement.setRoverPosition(3, 3, Coordinate.Heading.EAST);
		movement.execInstruction("MMRMMRMRRM");
		assertEquals("5 1 E", movement.getRoverPosition().printPosition());
	}
}
